...
#include "editor/font/font_lookups.hpp"

#include <ImReflect.hpp>

inline void tag_invoke(ImReflect::ImInput_t, const char* label, tmt::AudioEvent& value, ImSettings& settings, ImResponse& response) {
...
inline void tag_invoke(ImReflect::ImInput_t, const char* label, tmt::VolumeControl& value, ImSettings& settings, ImResponse& response) {
    if (ImGui::Button(ICON_MS_CLEAR)) value = {};
    ImGui::SameLine();
