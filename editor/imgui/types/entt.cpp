...
void display_entity_recursive(entt::entity entity, entt::entity& selected_value, ImReflect::type_response<entt::entity>& response, std::string& search_filter, int depth = 0) {
...
void entity_selector_popup(const char* popup_id, entt::entity& value, ImReflect::type_response<entt::entity>& response) {
...
bool entity_drag_drop_target(entt::entity& value, ImReflect::type_response<entt::entity>& response) {
...
void tag_invoke(ImReflect::ImInput_t, const char* label, entt::entity& value, ImSettings& /*settings*/, ImResponse& response) {
    ...
    entity_drag_drop_target(value, entity_response);
    ...
    entity_selector_popup(popup_id, value, entity_response);
